            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div id="toolbar">
                        ...
                        <a id="add" href="/new-user" class="btn btn-primary">

                            <i class="fa fa-plus"></i> Add User
                        </a>
                        <a id="projectview" href="/img" class="btn btn-secondary">

                            <i class="fa fa-image"></i> Employee Photos
                        </a>
                    </div>
                    <table id="table" class="mt-5" data-toggle="table" data-toolbar="#toolbar"
                        ...
                        <thead>
                            <tr>
                                ...
                                <th>Id</th>
                                <th>First Name</th>
                                <th data-field="lastName" data-filter-control="select" data-sortable="true">Last Name</th>
                                <th>Email</th>
                                <th>Username</th>
                                <th>Password</th>
                            ...
                            @if (is_array($users) || is_object($users))
                                @forelse ($users as $key => $item)
                                    <tr>
                                        ...
                                        <td><a href="{{ url('edit-newuser/' . $key) }}" class="btn btn-sm btn-success">
                                                EDIT
                                            </a></td>

                                        <td>
                                            <form action="{{ url('delete-newuser/' . $key) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
